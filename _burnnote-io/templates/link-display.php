...
<body>
  <div class="burnnote-container">
    <div class="burnnote-header">
      ...
      <h2>Your Private Link Is Ready</h2>
      <p class="burnnote-subtext" id="note-description">This secure note can only be viewed once. <br>
        	After it's opened, it self-destructs and is permanently burned.</p>
    </div>
